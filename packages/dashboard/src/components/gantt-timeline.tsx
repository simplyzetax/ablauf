            ...
            <div className="relative h-5">
              ...
              {entry.retryHistory?.map((retry) => {
                ...
                return (
                  <div
                    key={retry.attempt}
                    className={`absolute top-0 h-full rounded ${color} opacity-30`}
                    style={{
              ...
              >
                ...
                {/* Tooltip */}
                <div className="invisible absolute bottom-full left-1/2 z-10 mb-1 -translate-x-1/2 whitespace-nowrap rounded bg-zinc-800 px-2.5 py-1.5 text-xs text-white shadow-lg group-hover:visible">
