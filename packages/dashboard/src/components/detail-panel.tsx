			...
			<div className="space-y-5">
				...
				<div>
					<div className="flex items-center gap-3">
						<span className="font-mono text-lg text-zinc-100">{workflow.id}</span>
						<button
				...
				{/* Error banner */}
				{workflow.error && (
					<div className="rounded-lg border border-red-800/50 bg-red-950/50 p-3 text-sm text-red-300">{workflow.error}</div>
				)}
