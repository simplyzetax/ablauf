...
Ready to build? Head to [Getting Started](/docs/getting-started) to create your first workflow.

Want to dive deeper? Check out:

- [Workflows](/docs/workflows) — Learn how to define workflows with `defineWorkflow()` and `BaseWorkflow`
- [Steps](/docs/steps) — Master `step.do()`, `step.sleep()`, and `step.waitForEvent()`
- [Events](/docs/events) — Send typed events to running workflows
- [Observability](/docs/observability) — Stream real-time updates via SSE
