...
<auto-type-table path="../../../../../packages/workflows/src/engine/types.ts" name="ResultSizeLimitConfig" />
...
See [Supported Transport Types](/docs/workflows/transport-types) for the full list of allowed types.
...
See [Skipping Retries with NonRetriableError](/docs/workflows/retries#skipping-retries-with-nonretriableerror) for more details and examples.
...
See [Supported Transport Types](/docs/workflows/transport-types) for the complete list of available types, excluded types, and migration guide.
