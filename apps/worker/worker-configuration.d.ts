/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b47d5dd9befd31a5d5c7cdf58a3b6eed)
// Runtime types generated with workerd@1.20260212.0 2026-02-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
		durableNamespaces: 'WorkflowRunner';
	}
	interface Env {
		BENCHMARK_TOKEN: string;
		WORKFLOW_RUNNER: DurableObjectNamespace<import('./src/index').WorkflowRunner>;
		CF_BENCH_WORKFLOW: Workflow<Parameters<import('./src/index').BenchmarkCloudflareWorkflow['run']>[0]['payload']>;
	}
}
